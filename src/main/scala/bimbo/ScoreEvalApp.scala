...
object ScoreEvalApp extends LazyLogging {
  ...
  //  val testItems = testItemByProductDAO.getProductItems(43169)//.filter(i => i.depotId==1387) //getTestwItems(trainItemDAO, testItemByProductDAO)//testItemByProductDAO.getProductItems(1278)// //testItemByProductDAO.getProductItems(43175) 
