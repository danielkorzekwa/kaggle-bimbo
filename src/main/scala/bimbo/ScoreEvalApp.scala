...
object ScoreEvalApp extends LazyLogging {
  ...
  //   val testItems =  testItemByProductDAO.getProductItems(4270)//getTestItems(trainItemDAO, testItemByProductDAO)//testItemByProductDAO.getProductItems(1278)// //testItemByProductDAO.getProductItems(43175) 
